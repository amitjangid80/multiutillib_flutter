...
const verticalSpace42 = SizedBox(height: 42);
const verticalSpace48 = SizedBox(height: 48);
...
const horizontalSpace42 = SizedBox(width: 42);
const horizontalSpace48 = SizedBox(width: 48);
const horizontalSpace54 = SizedBox(width: 54);
const horizontalSpace60 = SizedBox(width: 60);
